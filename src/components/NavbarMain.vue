<template>
    <div>
        <header :class="isVisible === true ? 'hidden' : 'visible'">
        ...
        <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'"
            ...
            <div v-for="(item, index) in carts" :key="index">
                <div class="flex justify-between mt-6">
                    <div class="flex">
                        <img class="h-20 w-20 object-cover rounded" :src="item.product.thumbnail" alt="">
                        <div class="mx-3">
                    ...
                    <div class="flex gap-5">
                        <span class="self-center text-gray-600">${{ item.total_price }}</span>
                    </div>
                </div>
                <div class="flex justify-end">
                    <button
                        @click.prevent="handleRemoveCart(index)"
                        class="px-1 py-1 bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">
                        Delete
                    </button>
                </div>
            </div>
            ...
            <div @click="navigateCheckout()" class="flex items-center justify-center mt-4 px-3 py-2 
            bg-blue-600 text-white text-sm uppercase font-medium rounded 
            hover:bg-blue-500 focus:outline-none focus:bg-blue-500 cursor-pointer">
                <span>Checkout</span>
...
export default {
    ...
    setup() {
        ...
        watch(() => cartStore.carts, (newCarts) => {
            cartStore.saveCarts();
        }, { deep: true });
    ...
    methods: {
        navVisible() {
            ...
            if (url === '/dashboard'|| url === '/payment' || url === '/admin/list-order') {
                this.isVisible = true
            }
        }
    },
